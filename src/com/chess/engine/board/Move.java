...
public abstract class Move {
    ...
    public static final Move NULL_MOVE = new MajorMove.NullMove();

    public Move(Board board, Piece movedPiece, final int destinationCoordinate) {
        this.board = board;
    ...
    public Board execute() {
        ...
        //if piece is not moved then set it, oponnent has no need for if (he is not in the position to move)
